...
?>
  ...
  <center>
      ...
      <tr>
        ...
        <td><input type="text" id="ename" name="functionName" value="" onkeyup="enameValid()">
     ...
     <tr>
      ...
      <tr>
        <td colspan=2 align=right>
          ...
          <input type="button" onclick="location.href='salary.php';" value="Back">
        </td>
      </tr>
    </table>
          <?php echo $Errormsg;?>
      ...
      var name = document.getElementById('eid').value;
        ...
        for(var i=0 ; i<nameL ; i++ ){                                                  // one by one input characters checking
          ...
          if(name == "" || name == null){
            ...
            document.getElementById('EID').innerHTML = "Type valid characters!";
